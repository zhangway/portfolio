...
import no.uit.zhangwei.Model.runkeeper.User;
import no.uit.zhangwei.runkeeper.Callback;
import no.uit.zhangwei.runkeeper.ClientException;
import no.uit.zhangwei.runkeeper.ContentTypes;
